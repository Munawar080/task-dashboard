...
export default function ColumnContainerHeader({label, icon, numberOfItems = 0, openPopup}: ColumnContainerHeaderProps) {
  return (
   <div className="header flex justify-between px-3 py-2">
                    ...
                    <div className='flex gap-2 justify-between items-center text-gray-400 '>
                      ...
                      <FaPlus onClick={openPopup} className="text-sm"/>
                        </div>
                    </div>
                  </div>
  )
